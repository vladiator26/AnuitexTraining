...
namespace AnuitexTraining.BusinessLogicLayer.Providers
{
    public class ExchangeRateProvider
    {
        ...
        public ExchangeRateProvider()
        {
            ...
            string json = client.DownloadString("https://v6.exchangerate-api.com/v6/f32774e0581819e2bbf8ced6/latest/USD");
        ...
        {
            return value / (double)_exchangeRate.conversion_rates.GetType().GetProperty(currencyType.ToString()).GetValue(_exchangeRate.conversion_rates);
        }
    }
}
